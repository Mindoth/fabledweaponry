...
public class FabledWeaponryItems {
    ...
    public static final RegistryObject<Item> GREATSWORD_WOOD = ITEMS.register("greatsword_wood",
            () -> new SwordItem(ItemTier.WOOD, 5, -2.4F, new Item.Properties().tab(ItemGroup.TAB_COMBAT).stacksTo(1)));

    public static final RegistryObject<Item> WARAXE_WOOD = ITEMS.register("waraxe_wood",
            () -> new AxeItem(ItemTier.WOOD, 8, -3.5F, new Item.Properties().tab(ItemGroup.TAB_COMBAT).stacksTo(1)));

    public static final RegistryObject<Item> MAUL_WOOD = ITEMS.register("maul_wood",
            () -> new SwordItem(ItemTier.WOOD, 8, -3.5F, new Item.Properties().tab(ItemGroup.TAB_COMBAT).stacksTo(1)));

    public static final RegistryObject<Item> SCYTHE_WOOD = ITEMS.register("scythe_wood",
            () -> new SwordItem(ItemTier.WOOD, 2, -2.4F, new Item.Properties().tab(ItemGroup.TAB_COMBAT).stacksTo(1)));
