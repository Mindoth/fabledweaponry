...
public class LongbowIron extends LongbowItem {
    public LongbowIron(Properties p_i48522_1_) {
        super(p_i48522_1_);
    }
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!pLevel.isClientSide) {
                        ...
                        abstractarrowentity.shootFromRotation(playerentity, playerentity.xRot, playerentity.yRot, 0.0F, f * 6.0F, 0.5F);
                        if (f == 1.0F) {
