...
public class LongbowGold extends LongbowItem {

    public LongbowGold(Properties p_i48522_1_) {
        super(p_i48522_1_);
    }
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!pLevel.isClientSide) {
                        ...
                        abstractarrowentity.shootFromRotation(Player, Player.getXRot(), Player.getYRot(), 0.0F, f * 4.0F, 0.5F);
                        if (f == 1.0F) {
